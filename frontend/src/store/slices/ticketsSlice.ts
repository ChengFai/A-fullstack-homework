  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error?.response?.data?.detail || error?.message || '获取票据失败'
      );
    }
  }
);
...
export const createNewTicket = createAsyncThunk(
  ...
  async (ticketData: CreateTicketData, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error?.response?.data?.detail || error?.message || '创建票据失败'
      );
    }
  }
);
...
export const approveTicketAction = createAsyncThunk(
  ...
  async (ticketId: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error?.response?.data?.detail || error?.message || '批准票据失败'
      );
    }
  }
);
...
export const denyTicketAction = createAsyncThunk(
  ...
  async (ticketId: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error?.response?.data?.detail || error?.message || '拒绝票据失败'
      );
    }
  }
);
...
export const deleteTicketAction = createAsyncThunk(
  ...
  async (ticketId: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error?.response?.data?.detail || error?.message || '删除票据失败'
      );
    }
  }
);
